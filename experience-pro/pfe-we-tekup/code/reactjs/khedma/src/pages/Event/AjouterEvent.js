...
//         setFormData({ ...formData, price: value === "Sans Frais" ? "0.00" : formData.price });
//     } else {
    ...
    if (idUser) {
     ...
     // Ajout de 'price' avec la valeur correcte basée sur l'option choisie
      ...
      const response = await axios.post(`/event-create/`, formdata, {
        ...
        toast.success('L\'événement a été ajouté avec succès et est en attente d\'acceptation par l\'administrateur.', {
          position: toast.POSITION.TOP_RIGHT,
          autoClose: 4000 
        });
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-7">
              <h1 className="text-white font-weight-bold">Créer un Evenement</h1>
              <div className="custom-breadcrumbs">
                <a href="#">Accueil</a> <span className="mx-2 slash">/</span>
                <span className="text-white"><strong>Publier Event</strong></span>
              </div>
            </div>   
          </div>
        </div>
...
<div className="col-md-6 mt-3 mt-md-4">
      ...
      <label className="categorie-box" style={{ width: '100%', display: 'flex', alignItems: 'center' }}>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={handleCloseModal}>
            ...
            <div className="row">
       <div className="col-md-6 mt-3 mt-md-0">
    <label className="text-black" htmlFor="image" style={{ marginLeft: '-180px' }}>
      <span className="event-label-span">Image </span>
    </label><br />
    <input
      type="file"
      accept="image/*"
    ...
    />
      ...
      <button
       type="submit"
       className="btn btn-primary btn-block btn-lg d-block mx-auto"
...
const ConnectedAjouterEvent = connect(mapStateToProps)(AjouterEvent);

export default ConnectedAjouterEvent;
